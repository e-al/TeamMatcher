 --
DROP IF EXISTS DATABASE teammatcher$TeamMatcher;
...
CREATE TABLE ProjectSkill(
        Project_Skill_Id int(11) AUTO_INCREMENT PRIMARY KEY,
        Name varchar(100)
        );
...
CREATE TABLE ProjectNeedsSkill(
        ...
        Project_Id int(11),
        Project_Skill_Id int(11),
    	FOREIGN KEY (Project_Id) REFERENCES Project(Project_Id),
        FOREIGN KEY (Project_Skill_Id) REFERENCES ProjectSkill(Project_Skill_Id)
        );
...
CREATE TABLE StudentHasTime(
        Student_Has_Time_Id int(11) AUTO_INCREMENT PRIMARY KEY,
    	Student_Id int(11),
        Available_Time_Id int(11),
        FOREIGN KEY (Student_Id) REFERENCES Student(Student_Id),
        FOREIGN KEY (Available_Time_Id) REFERENCES Available_Time(Available_Time_Id)
        );

CREATE TABLE AvailableTime(
        Available_Time_Id AUTO_INCREMENT PRIMARY KEY,
        Team_Id int(11),
